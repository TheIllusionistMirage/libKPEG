...
namespace kpeg
{
    namespace types
    {
        ...
        /// Generic enum for dealing with components
        /// in a three-channel color model
        enum Components
        {
            COMP1 ,
            COMP2 ,
        ...
        /// Enum for identifying with channels in Y-Cb-Cr model
        ...
        /// Pixel with floating point (continuous) component values
        struct FPixel
        {
            /// Default constructor
            ///
        ...
        /// A 2D array of pixels with floatin-point (continuous) components
